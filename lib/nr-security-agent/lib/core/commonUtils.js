...
const { CSEC_HOME, SLASH, EMPTY_STR, APPLICATION_JSON, APPLICATION_XML, APPLICATION_X_FORM_URLENCODED } = require('./sec-agent-constants');
    ...
    try {
        ...
        switch (contentType) {
            ...
            case APPLICATION_X_FORM_URLENCODED:
                return checkForAccountRestrictionToFormBody(request);
                break;
        }
    } catch (error) {
