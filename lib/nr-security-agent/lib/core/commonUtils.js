...
function getLogfilePath(){
    const apmLogFilePath = NRAgent && NRAgent.config && NRAgent.config.logging.enabled ? NRAgent.config.logging.filepath : EMPTY_STR;
    return apmLogFilePath;
}
