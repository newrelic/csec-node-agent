...
function createDirectories () {
    ...
    createPathIfNotExist(`${CSEC_HOME}${SLASH}nr-security-home/tmp${SLASH}language-agent${SLASH}${getUUID()}`);
    createPathIfNotExist(`${CSEC_HOME}${SLASH}nr-security-home/tmp${SLASH}language-agent${SLASH}${getUUID()}/ds-tmp`);
    try {
