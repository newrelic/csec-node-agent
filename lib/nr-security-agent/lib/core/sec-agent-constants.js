...
let CSEC_HOME = NRAgent &&  NRAgent.config.newrelic_home ? NRAgent.config.newrelic_home  : require('path').join(process.cwd());
...
module.exports = {
    ...
    LOG_DIR: `${CSEC_HOME}/nr-security-home/logs/`,
    CSEC_HOME_TMP: `${CSEC_HOME}/nr-security-home/tmp/language-agent/${process.env.applicationUUID}`,
    AGENT_START_TIME: agentStartTime,
    FRAMEWORK: '',
    STATUS_LOG_FILE: `${CSEC_HOME}/nr-security-home/logs/snapshots/node-security-collector-status-${process.env.applicationUUID}.log`,
    ...
    CSEC_LAST_FUZZ_REQUEST_TIME: 'CSEC_LAST_FUZZ_REQUEST_TIME',
    ...
    LOG_MESSAGES: {
        ...
        COLLECTOR_INFO: ' CSEC Node version : %s , json version : %s and build number : %s',
        ...
        POLICY_APPLIED: '[STEP-7][COMPLETE][POLICY] Policy Applied :',
        ...
        COLLECTOR_INIT_WITH_PROP: 'Collector Is Initialized With Properties:',
        ...
        FIRST_EVENT_SENT: '[STEP-8][COMPLETE][EVENT] First Event Sent For Validation',
