...
const initialize = function () {
    ...
    // Initiate HC send routine in the provided hcInterval.
    initLogger.info(LOG_MESSAGES.SCHED_SERVICE_START);
    initLogger.info(LOG_MESSAGES.START_HC);

    setTimeout(() => {
        setInterval(sendHC, HC_INTERVAL_MS);
        initLogger.info(LOG_MESSAGES.END_HC);
        sendHC();
    }, 30000);
