...
const findFileSeperator = '{{NR_CSEC_VALIDATOR_FILE_SEPARATOR}}';
const File_SEPERATOR_CONST = new RegExp(findFileSeperator, 'g');
...
function handler (json) {
    ...
    rawFuzzRequest = rawFuzzRequest.replace(File_SEPERATOR_CONST, path.sep);
