...
module.exports.handler = function handler(json) {
    try {
        ...
        initLogger.info(LOG_MESSAGES.COLLECTOR_INIT_WITH_PROP, JSON.stringify(startupConfig.config));
        initLogger.info('Collector is now ACTIVE for', applicationInfoModule.getInstance().applicationUUID);
