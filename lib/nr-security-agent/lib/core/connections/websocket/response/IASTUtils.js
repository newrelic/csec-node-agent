...
function generateIASTDataRequest() {
    ...
    if (NRAgent.config.security.scan_controllers.iast_scan_request_rate_limit) {
        let scanRateLimit = NRAgent.config.security.scan_controllers.iast_scan_request_rate_limit;
