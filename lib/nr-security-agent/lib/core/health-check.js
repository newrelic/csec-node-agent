...
const IASTReplayRequest = require('./iastReplayRequest');
const WebSocketConnectionStats = require('./webSocketConnectionStats');
...
function HC(info) {
    ...
    this.pid = info.pid;
    this.eventStats = {};
    this.eventStats.iastEventStats = EventStats.getInstance();
    this.eventStats.raspEventStats = EventStats.getInstance();
    this.eventStats.exitEventStats = EventStats.getInstance();
    this.iastReplayRequest = IASTReplayRequest.getInstance();
    this.webSocketConnectionStats = WebSocketConnectionStats.getInstance();
    ...
    this.resetIASTEventStats = function () {
        this.eventStats.iastEventStats.processed = 0;
        this.eventStats.iastEventStats.sent = 0;
        this.eventStats.iastEventStats.rejected = 0;
        this.eventStats.iastEventStats.errorCount = 0;
    };
    ...
    */
    this.resetRASPEventStats = function () {
        this.eventStats.raspEventStats.processed = 0;
        this.eventStats.raspEventStats.sent = 0;
        this.eventStats.raspEventStats.rejected = 0;
        this.eventStats.raspEventStats.errorCount = 0;
    };
    ...
    this.resetEXITEventStats = function () {
        this.eventStats.exitEventStats.processed = 0;
        this.eventStats.exitEventStats.sent = 0;
        this.eventStats.exitEventStats.rejected = 0;
        this.eventStats.exitEventStats.errorCount = 0;
    };

     /**
     * resets the IastReplayRequest
     */
     this.resetIastReplayRequest = function () {
        this.iastReplayRequest.receivedControlCommands = 0;
        this.iastReplayRequest.processedControlCommands = 0;
        this.iastReplayRequest.pendingControlCommands = 0;
        this.iastReplayRequest.replayRequestGenerated = 0;
        this.iastReplayRequest.replayRequestExecuted = 0;
        this.iastReplayRequest.replayRequestSucceeded = 0;
        this.iastReplayRequest.replayRequestFailed = 0;
        this.iastReplayRequest.replayRequestRejected = 0;
    };

    /**
     * resets the IastReplayRequest
     */
    this.resetWebSocketConnectionStats = function () {
        this.webSocketConnectionStats.messagesSent = 0;
        this.webSocketConnectionStats.messagesReceived = 0;
        this.webSocketConnectionStats.connectionReconnected = 0;
        this.webSocketConnectionStats.connectionFailure = 0;
        this.webSocketConnectionStats.receivedReconnectAtWill = 0;
        this.webSocketConnectionStats.sendFailure = 0;
    };
    ...
    */
    this.resetEventStats = function () {
        ...
        this.resetIASTEventStats();
        this.resetWebSocketConnectionStats();
        this.resetIastReplayRequest();
    };
