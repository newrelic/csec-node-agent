...
function generateTransactionEvent(request, response) {
  ...
  transactionEvent.response.responseBody = response.res.body;
  transactionEvent.response.responseCode = response.statusCode;
  transactionEvent.response.headers = response.getHeaders();
  transactionEvent.response.contentType = response.getHeader(CONTENT_TYPE);
