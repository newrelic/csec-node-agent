...
let CSEC_HOME = NRAgent && NRAgent.config && NRAgent.config.newrelic_home ? NRAgent.config.newrelic_home : require('path').join(process.cwd());
CSEC_HOME = NRAgent && NRAgent.config.logging.filepath ? path.dirname(NRAgent.config.logging.filepath): CSEC_HOME;
