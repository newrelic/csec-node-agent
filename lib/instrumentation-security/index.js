...
newrelic.instrumentDatastore({
  moduleName: 'ioredis',
  isEsm: true,
  onRequire: require('./hooks/ioredis/nr-ioredis'),
  onError: function intrumentErrorHandler(err) {
    logger.error(err.message, err.stack)
  }
})
...
newrelic.instrumentDatastore({
  moduleName: 'redis',
  isEsm: true,
  onRequire: require('./hooks/redis/nr-redis'),
  onError: function intrumentErrorHandler(err) {
    logger.error(err.message, err.stack)
  }
})
...
newrelic.instrumentDatastore({
  ...
  isEsm: true,
  onRequire: require('./hooks/redis/nr-redis-client'),
  onError: function intrumentErrorHandler(err) {
    logger.error(err.message, err.stack)
  }
})
