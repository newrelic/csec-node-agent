...
function getNRAgent() {
    ...
    if (NRAgent && NRAgent.config && !NRAgent.config.security.monitoring_criteria){
        NRAgent.config.security.monitoring_criteria = {};
        NRAgent.config.security.monitoring_criteria.event_quota_per_trace = 100;
        NRAgent.config.security.monitoring_criteria.event_quota_time_duration = 360;
        NRAgent.config.security.monitoring_criteria.repeat = 0;
    }
    return NRAgent;
}
