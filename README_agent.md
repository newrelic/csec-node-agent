# *The New Relic csec-node-agent is in preview and licensed under the New Relic Pre-Release Software Notice.*

# New Relic csec-node-agent [build badges go here when available]

The New Relic csec-node-agent is not generally available.  To participate in the New Relic CSEC Agent preview, follow the steps outlined here.
...
If you would like to contribute feedback to this project, review [these guidelines](./CONTRIBUTING.md).
